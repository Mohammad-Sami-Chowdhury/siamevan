        ...
        return r(s, [{
            ...
            value: function() {
                ...
                this.options.nextStringDelay = {
                    ...
                    total: e ? this.options.nextStringDelay.reduce(function(e, t) {
                        return e + t
                    }) : this.options.nextStringDelay
                }
            }
            ...
            value: function() {
                ...
                this.options.strings.forEach(function(t, n) {
                    e.queueString(t),
                    n + 1 < e.options.strings.length && (e.options.breakLines ? (e.queue.push([e.break]),
                    e.insertSplitPause(e.queue.length)) : (e.queueDeletions(t),
            ...
            key: "queueDeletions",
            value: function() {
                for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null, t = "string" == typeof e ? e.length : e, n = 0; n < t; n++)
            ...
            value: function(e) {
                ...
                if (e) {
                    ...
                    this.options.html && n(e[0], "<") && !n(e[0], "</")) {
                        ...
                        this.queue.push([this.type, e[0]]);
                    e.splice(0, 1),
                    e.length && this.queueString(e, !1)
                }
            }
        }, {
            ...
            value: function(e) {
                ...
                this.queue.splice(e, 0, [this.pause, this.options.nextStringDelay.before]),
                this.queue.splice(e - t, 0, [this.pause, this.options.nextStringDelay.after])
            }
        }, {
            key: "kickoff",
            value: function() {
                ...
                window.addEventListener("scroll", function n(i) {
                    e(t.element) && !t.hasStarted && (t.hasStarted = !0,
                    t.next(),
            ...
            value: function(e) {
                ...
                this.timeouts[0] = setTimeout(function() {
                    return "string" != typeof e ? (e.innerHTML = "",
                    t.elementContainer.appendChild(e),
                    t.isInTag = !0,
                    void t.next()) : n(e, "</") ? (t.isInTag = !1,
                    void t.next()) : (t.insert(e, t.isInTag),
                    void t.next())
                }, this.typePace)
            }
        }, {
            ...
            value: function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null
                  ...
                  , i = {};
                for (var s in null === t && (t = this.options),
                t)
                    i[s] = t[s];
                for (var o in e)
                    i[o] = e[o];
            ...
            value: function() {
                ...
                this.timeouts[1] = setTimeout(function() {
                    ...
                    e.elementContainer.innerHTML = n.join("").replace(/<[^\/>][^>]*><\/[^>]+>/, ""),
            ...
            value: function() {
                ...
                if (!this.isFrozen) {
                    if (this.queue.length > 0) {
                        ...
                        void t[0].call(this, t[1])
                    }
                    this.options.callback(),
                    this.options.loop ? (this.queueDeletions(this.elementContainer.innerHTML),
                    this.generateQueue([this.pause, this.options.loopDelay / 2]),
                    setTimeout(function() {
                        e.next()
                    }, this.options.loopDelay / 2)) : this.isComplete = !0
                }
            }
        }]),
        s
    ...
    return function() {
        ...
        return r(e, [{
            ...
            value: function() {
                ...
                return this.pushAction("delete", e),
                this
            }
        }, {
            key: "freeze",
            ...
            value: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
                return this.pushAction("pause", e),
                this
            }
        }, {
            key: "destroy",
            ...
            key: "empty",
            value: function() {
                return this.pushAction("empty"),
                this
            }
        }, {
            key: "break",
            value: function() {
                return this.pushAction("break"),
                this
            }
        }, {
            key: "options",
            value: function(e) {
                return this.pushAction("setOptions", e),
                this
            }
        }, {
            key: "isComplete",
